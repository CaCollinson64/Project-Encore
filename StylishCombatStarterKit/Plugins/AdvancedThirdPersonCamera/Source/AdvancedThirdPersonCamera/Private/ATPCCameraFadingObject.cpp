...
#include "Engine/World.h"        // For GetWorld() function
#include "CollisionQueryParams.h"  // For OverlapMultiByChannel and FCollisionShape
...
void UATPCCameraFadingObject::SelfFade()
{
	...
	auto owningActorOverlapRes = overlapResults.FindByPredicate([owningActor](FOverlapResult& OverlapRes) {
