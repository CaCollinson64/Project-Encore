...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSUDSExpression_Statics::NewProp_Queue_Inner = { "Queue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSUDSExpressionItem, METADATA_PARAMS(0, nullptr) }; // 272867855
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSUDSExpression_Statics::NewProp_Queue = { "Queue", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSUDSExpression, Queue), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Queue_MetaData), NewProp_Queue_MetaData) }; // 272867855
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Git_Project_Encore_StylishCombatStarterKit_Plugins_SUDSPro_Source_SUDS_Public_SUDSExpression_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSUDSExpressionItem::StaticStruct, Z_Construct_UScriptStruct_FSUDSExpressionItem_Statics::NewStructOps, TEXT("SUDSExpressionItem"), &Z_Registration_Info_UScriptStruct_SUDSExpressionItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSUDSExpressionItem), 272867855U) },
		{ FSUDSExpression::StaticStruct, Z_Construct_UScriptStruct_FSUDSExpression_Statics::NewStructOps, TEXT("SUDSExpression"), &Z_Registration_Info_UScriptStruct_SUDSExpression, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSUDSExpression), 169834246U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_Project_Encore_StylishCombatStarterKit_Plugins_SUDSPro_Source_SUDS_Public_SUDSExpression_h_2823077533(TEXT("/Script/SUDS"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Git_Project_Encore_StylishCombatStarterKit_Plugins_SUDSPro_Source_SUDS_Public_SUDSExpression_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_Project_Encore_StylishCombatStarterKit_Plugins_SUDSPro_Source_SUDS_Public_SUDSExpression_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Git_Project_Encore_StylishCombatStarterKit_Plugins_SUDSPro_Source_SUDS_Public_SUDSExpression_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_Project_Encore_StylishCombatStarterKit_Plugins_SUDSPro_Source_SUDS_Public_SUDSExpression_h_Statics::EnumInfo));
// End Registration
